...
import { FindjobComponent } from './components/pages/findjob/findjob.component';
import { PopularServiceComponent } from './components/pages/home-demo-one/popular-service/popular-service.component'
import { HireformComponent } from './components/pages/findjob/hireform/hireform.component';
import { PropertyrentComponent } from './components/pages/propertyrent/propertyrent.component';
import { DeliveryItemComponent } from './components/pages/delivery-item/delivery-item.component';
...
// import { HireStaffComponent } from './components/pages/findjob/hire-staff/hire-staff.component'
...
const routes: Routes = [
    ...
    {path: 'popular-service', component: PopularServiceComponent },
    {path: 'hireform', component: HireformComponent },
    {path: 'propertyrent', component: PropertyrentComponent},
    {path: 'delivery-item', component: DeliveryItemComponent},
    {path: 'privacy-policy', component:PrivacyPolicyComponent},  
    {path: 'terms-conditions',component:TermsConditionsComponent},
        // {path: 'hire-staff', component: HireStaffComponent},
